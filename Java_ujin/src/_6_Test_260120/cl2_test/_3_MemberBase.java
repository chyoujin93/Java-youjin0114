...
public abstract class _3_MemberBase {
    ...
    // protected 필드는 상속받은 자식 클래스만 접근 가능한 변수,
    // 이름 메일 나이 같은 정보는 메인클래스에서는 직접 접근 못하게하기위해 선언
...
//    public _3_MemberBase(String name, String email, int age) {
    public _3_MemberBase(String name, String email,String password, int age) {
        this.name = name;
        this.email = email;
        this.password = password;  // 260120_실습4_풀이, 순서4, 멤버 추가.
        this.age = age;
    }

    public abstract void showInfo(); // 회원 정보 출력용 추상 메서드로 선언
